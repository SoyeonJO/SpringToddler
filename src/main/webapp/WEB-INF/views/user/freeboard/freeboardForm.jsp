...
//     });
	...
	$('#freeboardForm').submit(function(){
		...
		$(this).append('<input type="hidden" name="bo_writer" value="a001"></input>');
...
<body>
<form id="freeboardForm" class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
